  ...
  const myQuestions = [ //This required js encryption
    {
...
(function(){
  ...
  var gameOverHTML = "" //Code Modded 
    if (point>=12){
      gameOverHTML += "<h4 style='color: green;'>Cogratulations. !!!</h4>"
    }

    if (point<12){
      gameOverHTML += "<h4 style='color: red;'>Try Harder, Next Time</h4>"
    }
  gameOverHTML += "<h4>You have score : " + point+ " out of 20 points.</h4>"
